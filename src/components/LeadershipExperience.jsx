            ...
            >
                ...
                <div className="bg-black/80 backdrop-blur-md rounded-xl p-8 sm:p-10 w-full h-full flex flex-col justify-between min-h-[500px] sm:min-h-[600px]">
                  ...
                  {item.hours && (
                    <div className="flex justify-center mb-6">
                      <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                        <span className="text-white font-bold text-xl">{item.hours}</span>
                        <span className="text-gray-300 text-lg ml-1">Hours</span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="flex-grow flex flex-col justify-center">
                    ...
                    <p className="text-center text-blue-300 font-semibold text-xl mb-4">
                      {item.role}
                    </p>
                    {item.organization && (
