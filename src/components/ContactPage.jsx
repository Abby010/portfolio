...
export default function ContactPage() {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen flex items-center justify-center py-6 sm:py-8 px-4 sm:px-8 relative overflow-hidden"
    >
      <div className="w-full max-w-5xl mx-auto relative">
        ...
        <motion.h2
          ...
          className="text-3xl sm:text-5xl md:text-6xl font-black text-center mb-6 sm:mb-10 tracking-wider relative"
        >
          ...
          <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-28 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent rounded-full" />
        </motion.h2>
        ...
        <div className="flex flex-col items-center justify-center gap-6 w-full">
          ...
          >
            <div className="relative group w-full max-w-[720px]">
              ...
              <div className={`relative backdrop-blur-xl rounded-2xl p-6 sm:p-8 border w-full shadow-2xl ${
                currentTheme === 'dark'
